...
const categories = [
  {
    ...
    image: "https://images.unsplash.com/photo-1594486231930-e0b05c678a4e?w=400&h=500&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=400&h=500&fit=crop",
          ...
          <div className="col-span-3 border-r border-stone-200 pr-8">
            ...
            <nav className="space-y-1">
              ...
              <Link
                ...
                onClick={onClose}
                className="block w-full text-left px-3 py-2 text-fuchsia-600 font-medium hover:underline mt-4"
              >
                Shop All →
              </Link>
            </nav>
          ...
          <div className="col-span-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {activeCategory.subcategories.map((sub) => (
                <Link
                  ...
                  onClick={onClose}
                  className="px-3 py-2 text-stone-600 hover:text-fuchsia-600 hover:bg-stone-50 rounded transition-colors"
                >
                  {sub}
                </Link>
              ))}
            ...
            <div className="mt-6 pt-6 border-t border-stone-200">
              <Link
                href={`/collections/${activeCategory.handle}`}
                onClick={onClose}
                className="inline-flex items-center gap-2 text-fuchsia-600 font-medium hover:underline"
              >
