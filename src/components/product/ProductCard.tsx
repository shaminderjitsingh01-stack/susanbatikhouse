    ...
    <Link href={`/products/${product.handle}`} className="group">
      <div className="relative aspect-[3/4] bg-stone-100 rounded-2xl overflow-hidden mb-4 shadow-md group-hover:shadow-xl transition-all duration-500">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-10 h-10 bg-white/90 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#3EB8A4] hover:text-white shadow-md"
        >
      ...
      <p className="text-[#3EB8A4] font-bold text-lg mt-1">
