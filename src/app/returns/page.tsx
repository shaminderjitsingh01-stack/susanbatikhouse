      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-amber-800 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">
                1
              </div>
              <div>
        ...
        <section className="bg-amber-50 rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="px-6 py-3 border border-amber-800 text-amber-800 font-medium rounded-lg hover:bg-amber-100 transition-colors"
            >
              Contact Us
            </Link>
          </div>
