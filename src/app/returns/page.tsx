    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="bg-fuchsia-50 border border-amber-200 rounded-lg p-6 mb-6">
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="w-8 h-8 bg-fuchsia-600 text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">
                1
              </div>
              <div>
        ...
        <section className="bg-fuchsia-50 rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="px-6 py-3 border border-fuchsia-600 text-fuchsia-600 font-medium rounded-lg hover:bg-fuchsia-100 transition-colors"
            >
              Contact Us
            </Link>
          </div>
