      ...
      <div className="prose prose-stone max-w-none">
        <section className="mb-12">
          ...
          <div className="bg-stone-50 rounded-lg p-6 space-y-4">
            <div className="flex justify-between items-center border-b border-stone-200 pb-3">
              ...
              <span className="text-[#dc0e94] font-semibold">$5.00</span>
            </div>
            <div className="flex justify-between items-center border-b border-stone-200 pb-3">
              <span className="font-medium">Express Delivery (Next Day)</span>
              <span className="text-[#dc0e94] font-semibold">$12.00</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="font-medium">Free Shipping</span>
              <span className="text-[#dc0e94] font-semibold">Orders above $150</span>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-stone-600">
            ...
            <Link href="/contact" className="text-[#dc0e94] hover:underline">
              contact us
            </Link>{" "}
            or call us at{" "}
