        ...
        <section className="mb-12">
          ...
          <div className="bg-stone-50 rounded-lg p-6 space-y-4">
            <div className="flex justify-between items-center border-b border-stone-200 pb-3">
              ...
              <span className="text-fuchsia-600 font-semibold">$5.00</span>
            </div>
            <div className="flex justify-between items-center border-b border-stone-200 pb-3">
              <span className="font-medium">Express Delivery (Next Day)</span>
              <span className="text-fuchsia-600 font-semibold">$12.00</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="font-medium">Free Shipping</span>
              <span className="text-fuchsia-600 font-semibold">Orders above $150</span>
            </div>
          </div>
        </section>
