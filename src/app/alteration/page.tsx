    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-teal-400 tracking-[0.3em] uppercase text-sm mb-4">Expert Tailoring</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-stone-50 rounded-lg p-8">
              ...
              <p className="text-[#3EB8A4] font-semibold">From $15</p>
            </div>
            ...
            <div className="bg-stone-50 rounded-lg p-8">
              ...
              <p className="text-[#3EB8A4] font-semibold">From $20</p>
            </div>
            ...
            <div className="bg-stone-50 rounded-lg p-8">
              ...
              <p className="text-[#3EB8A4] font-semibold">From $30</p>
            </div>
            ...
            <div className="bg-stone-50 rounded-lg p-8">
              ...
              <p className="text-[#3EB8A4] font-semibold">From $35</p>
            </div>
            ...
            <div className="bg-stone-50 rounded-lg p-8">
              ...
              <p className="text-[#3EB8A4] font-semibold">Price on consultation</p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              <div className="w-12 h-12 bg-[#3EB8A4] text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold text-xl">
                1
              </div>
              <div>
      ...
      <section className="py-16 lg:py-24 bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+6565336330"
              className="px-8 py-4 bg-[#3EB8A4] hover:bg-[#3EB8A4] text-white font-medium rounded-lg transition-colors"
            >
              Call 6533 6330
            </a>
            <Link
