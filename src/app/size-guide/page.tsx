      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={row.size} className="hover:bg-stone-50">
                      <td className="border border-stone-200 px-4 py-3 font-medium text-[#E8A0BF]">{row.size}</td>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={row.type} className="hover:bg-stone-50">
                      <td className="border border-stone-200 px-4 py-3 font-medium text-[#E8A0BF]">{row.type}</td>
          ...
          <div className="mt-12 text-center">
            ...
            <Link
              href="/contact"
              className="inline-block px-8 py-4 bg-[#E8A0BF] text-white font-medium rounded-lg hover:bg-[#b30c78] transition-colors"
            >
