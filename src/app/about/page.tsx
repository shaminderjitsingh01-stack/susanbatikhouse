    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <h3 className="font-serif text-xl font-bold text-stone-900 mb-2 group-hover:text-[#dc0e94] transition-colors">
                  {item.title}
                </h3>
      ...
      <section className="py-16 lg:py-24 bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/contact"
            className="inline-block px-8 py-4 bg-[#dc0e94] hover:bg-[#dc0e94] text-white font-medium rounded transition-colors"
          >
            Get in Touch
          </Link>
        </div>
