    ...
    <>
      ...
      <section className="relative py-20 lg:py-32 bg-stone-900">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          <p className="text-amber-400 tracking-[0.3em] uppercase text-sm mb-4">Our Story</p>
      ...
      <section className="py-16 lg:py-24 bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8 mb-8">
            <div>
              <p className="text-amber-400 font-medium mb-2">Address</p>
              <p className="text-sm">
            ...
            <div>
              <p className="text-amber-400 font-medium mb-2">Hours</p>
              <p className="text-sm">
                Monday - Saturday<br />
                10:00am - 6:00pm<br />
                Sunday: Closed
            ...
            <div>
              <p className="text-amber-400 font-medium mb-2">Contact</p>
              <p className="text-sm">
                <a href="tel:+6565336330" className="hover:text-amber-400 transition-colors">
                  6533 6330
                </a>
              </p>
            </div>
          ...
          <Link
            href="/contact"
            className="inline-block px-8 py-4 bg-amber-700 hover:bg-amber-800 text-white font-medium rounded transition-colors"
          >
            Get in Touch
          </Link>
        </div>
