    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-[#EC4899]/10 rounded-lg -z-10" />
            </div>
            <div>
      ...
      <section className="py-16 lg:py-24 bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/contact"
            className="inline-block px-8 py-4 bg-[#EC4899] hover:bg-[#EC4899] text-white font-medium rounded transition-colors"
          >
            Get in Touch
          </Link>
        </div>
