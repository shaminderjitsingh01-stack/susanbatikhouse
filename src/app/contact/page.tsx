              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 text-[#3EB8A4] hover:text-[#b30c78] text-sm mt-2"
                    >
                      View on Google Maps
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+6565336330" className="text-stone-600 hover:text-[#3EB8A4] transition-colors">
                      6533 6330
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-stone-600 hover:text-[#3EB8A4] transition-colors"
                    >
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    className="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-colors resize-none"
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-[#3EB8A4] text-white font-medium rounded-lg hover:bg-[#b30c78] transition-colors"
                >
                  Send Message
                </button>
